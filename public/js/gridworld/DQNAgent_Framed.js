function DQNAgent_Framed(_env, _x, _y, _canvas) {
    this.env = _env;
    this.x = _x;
    this.y = _y;
    this.canvas = _canvas;
    ...
    this.append_sample = function(state, action, reward, next_state, done) {
        this.memory.push([math.reshape(state, [7,7,4]), action, reward, math.reshape(next_state, [7,7,4]), done]);
