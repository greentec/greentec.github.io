...
$(function() {
  ...
  // layer_defs.push({type:'reshape', out_sx:8, out_sy:8, in_depth:16384, out_depth:256});
  ...
  // layer_defs.push({type:'deconv', stride:2, pad:1, sx:5, sy:5, out_sx:64, out_sy:64, in_depth:64, out_depth:1, filters:1, activation:'sigmoid'});
